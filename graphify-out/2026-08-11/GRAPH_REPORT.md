...
## Corpus Check
- 232 files · ~175,490 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3538 nodes · 7270 edges · 193 communities (176 shown, 17 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 659 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `345f5bad`
...
## Communities (193 total, 17 thin omitted)

### Community 0 - "test_tui_command_palette.py"
Cohesion: 0.10
Nodes (29): Binding, anyio, Tests for Phase-4 command palette + prompt autocomplete., test_build_palette_items_kinds_and_visibility(), test_command_palette_composes_filters_and_selects(), test_command_palette_enter_runs_highlighted_item(), test_fuzzy_filter_empty_query_and_no_match(), test_fuzzy_filter_prefix_beats_substring() (+21 more)

### Community 1 - "datetime"
Cohesion: 0.13
Nodes (23): _build_excerpt(), LLM-powered SessionState extractor.  Replaces the regex-based _merge_summary_int, Build a compact conversation view for the extraction prompt., ContentChunk, ContentType, ContextSnapshot, MemoryNeedle, MemoryObject (+15 more)
...
Cohesion: 0.10
Nodes (21): ABC, asyncio, ExecutionPlan, Planning Skill for Torchlight.  Breaks down complex tasks into executable steps, BaseSkill, CalculatorSkill, create_default_registry(), _extract_markdown_skill_metadata() (+13 more)
...
### Community 14 - "GameOutcomeResult"
Cohesion: 0.13
Nodes (19): GameInputEvent, GameOutcomeResult, Represents an input action simulated during HTML game playback., Detailed diagnostic results after playing an HTML game., Formats the result into concise Markdown for LLM context., GameSelfImprovementReport, GameSelfImprover, ImprovementIteration (+11 more)
...
Cohesion: 0.09
Nodes (20): InferenceParams, Writing code files. Near-deterministic — exact syntax matters., Reasoning through plans. Moderate creativity. All tools remain available., Diagnosing errors. Slightly more exploration., General conversation., Dynamically return an InferenceParams preset calibrated for both         the tar, Send messages and return the full response., Send messages and yield response chunks. (+12 more)

### Community 18 - "ProjectMemory"
Cohesion: 0.08
Nodes (30): ensure_git_repository(), ensure_project_initialized(), init_new_project(), ProjectMemory, MemoryObject, Path, SessionState, Session and project memory persistence for Torchlight. (+22 more)
...
Cohesion: 0.13
Nodes (12): PlanningSkill, PlanStep, Any, Detect if a task likely needs planning., Create a structured plan for the task., Plan for creation/build/implementation tasks., Plan for refactoring tasks., Plan for testing tasks. (+4 more)
...
Cohesion: 0.10
Nodes (16): chat(), get_phase_system_prompt(), goal(), Panel, /params                    — show current params         /params auto, Start an interactive chat session with context management and flashlight., Start an autonomous goal execution session driven by .torchlight task tracking., Re-append closing tags and unclosed JSON braces that were consumed as stop token (+8 more)

### Community 28 - "cli/main.py"
Cohesion: 0.13
Nodes (13): command, _beam_budget(), compress_file(), count_tokens(), Compress a file using verbatim compaction., Count tokens in text., Manage saved sessions., Lock phase based on concrete execution events. (+5 more)

### Community 29 - "LLMClient"
Cohesion: 0.09
Nodes (19): LLMClient, Protocol, Protocol that all LLM backends must implement.      Both sync and async methods, Check if the backend is reachable., List available models., Simple query interface (for backward compatibility)., create_client(), _create_cloud_client() (+11 more)
...
Cohesion: 0.03
Nodes (47): anyio, Tests for Phase-5 tabbed editor split pane (open_file_tab, dirty marker, keyboar, test_close_file_tab_removes_from_open_tabs(), test_close_file_tab_switches_active_tab(), test_editor_split_pane_composes(), test_get_tab_hash(), test_keyboard_tab_navigation(), test_open_file_tab_registers_tab() (+39 more)
...
### Community 37 - "StaticHTMLValidator"
Cohesion: 0.14
...
### Community 45 - "test_autonomous_harness.py"
Cohesion: 0.28
...
### Community 47 - ".inspect"
Cohesion: 0.14
Nodes (9): Any, Path, QuietHTTPRequestHandler, Tier 3: Run Node JSDOM script if node is available., Tier 1: Static HTML analysis using Python standard library., Formats the result into compact Markdown suitable for LLM context., HTTP Request Handler that suppresses console logging noise., WebInspectionResult (+1 more)
...
Cohesion: 0.11
Nodes (33): Re-export TieredMemory and MemoryConfig from shared core library core.memory.man, Adaptive, headroom-driven context budget coordinator for Torchlight.  Static res, Tiered Memory Manager for Torchlight.  L0-L3 memory hierarchy with progressive c, Flatten whitespace/newlines and truncate a scratchpad entry to a bounded length., _scratchpad_clean(), ContentChunk, ContentType, ContextSnapshot (+25 more)
...
### Community 54 - "test_robust_task_tracking.py"
Cohesion: 0.40
Nodes (5): Tests for robust task and status tracking in LLM context and TUI., test_l0_scratchpad_integration(), test_validate_task_transition(), Validate if a task transition is valid according to the status state machine., validate_task_transition()

### Community 55 - "core/compression/summarizer.py"
Cohesion: 0.23
...
### Community 62 - "Static"
Cohesion: 0.07
Nodes (19): AgentMemoryWidget, AgentStatusModal, ComposeResult, Displays the live L0 Agent Brain Scratchpad., Modal dialog for complete visibility into background agent actions & status tele, ComposeResult, ComposeResult, ComposeResult (+11 more)
...
### Community 69 - "test_tui_tool_cards.py"
Cohesion: 0.17
Nodes (16): anyio, Tests for Phase-2 tool call cards (risk badge, status, timing, sections)., The streamed <tool_call> mounts a pending card completed by the step., test_app_pending_card_wiring(), test_summarize_args(), test_tool_card_complete_denied(), test_tool_card_complete_error_expands(), test_tool_card_complete_ok() (+8 more)

### Community 70 - "test_code_quality_harness.py"
Cohesion: 0.09
Nodes (36): Unit tests for Torchlight Zero-Context Code Quality Harness., test_check_syntax_js_bracket_balance(), test_check_syntax_js_string_literal_brackets(), test_check_syntax_json(), test_check_syntax_python(), test_compile_gate_rejects_return_outside_function(), test_detect_symptom_patching(), test_edit_file_blocks_broken_syntax() (+28 more)
...
### Community 78 - "test_timeout_retry.py"
Cohesion: 0.14
...
Cohesion: 0.05
Nodes (37): DirectiveTracker, Any, Directive tracker and constraint violation reinforcement module for Torchlight., Record a directive violation (e.g. 'cd_command', 'test_assertion_delete'), Reset violation counts., Tracks model constraint violations during execution turns and dynamically     in, extract_modified_symbols(), Extract function/class AST symbol names modified or added between old and new te (+29 more)

### Community 87 - "tui.sh"
Cohesion: 0.40
Nodes (5): cleanup(), COLORTERM, PYTHONPATH, tui.sh script, TERM

### Community 94 - "ShortcutsHelpModal"
Cohesion: 0.12
Nodes (9): Modal dialog displaying keyboard shortcuts and slash commands., ShortcutsHelpModal, CenterEmptyState, Container, Pressed, CenterEmptyState — the welcome / idle screen shown in the editor pane.  Replaces, Switch displayed content based on connection state., Route chip buttons to app-level actions. (+1 more)
...
### Community 113 - "Step"
Cohesion: 0.16
Nodes (14): A successful WRITE_FILE step mounts a DiffView card with real content., test_app_write_step_renders_diff_card(), test_dirty_marker_not_set_for_non_tab_file(), test_dirty_marker_set_on_write_step(), anyio, Tests for Phase-2 trajectory rail (pending → ok/error/denied dots)., The streamed <tool_call> adds a dot; the completing step flips it., test_app_pending_step_updates_rail() (+6 more)

### Community 114 - "SymbolIndex"
Cohesion: 0.14
Nodes (10): BeamResult, Flashlight Beam — query-to-code relevance scorer.  Scoring strategy (additive):, FileEntry, Path, Flashlight Indexer — scans the project and builds a searchable symbol index., SymbolIndex, test_file_entry(), test_symbol_index_build() (+2 more)

### Community 115 - "TaskManagerModal"
Cohesion: 0.11
Nodes (12): get_active_task_description(), Retrieve the title/description of the current active (in_progress) task, or firs, Modal dialog for interactive workspace task management & inspection., Open the interactive Task Manager modal screen., TaskManagerModal, ConnectionPill, ComposeResult, Horizontal (+4 more)
...
Cohesion: 0.13
Nodes (21): test_insert_task_into_plan_section(), test_mark_task_status_preserves_markdown(), test_status_badges_and_boxes(), _file_looks_complete(), insert_task_into_plan(), _is_task_match(), mark_task_in_progress(), mark_task_status() (+13 more)
...
### Community 148 - "tool_write_file_impl"
Cohesion: 0.10
Nodes (22): calculate_in_memory_diff(), Calculate exact lines added and deleted between two string buffers in RAM., test_detect_stubs(), test_tool_write_file_integration(), test_write_file_blocks_broken_syntax_and_truncation(), test_write_file_content_hash_dedup(), test_write_file_impl(), test_write_file_impl_missing_path() (+14 more)

### Community 149 - "AutonomousHarness"
Cohesion: 0.09
Nodes (23): AutonomousHarness, GoalSpec, Enum, Path, str, Autonomous Harness Driver for Torchlight.  Enables continuous, multi-epoch execu, Ensure target project has local git repository and persistent memory initialized, Ensure a goal spec exists on disk in .torchlight, initializing a default workspa (+15 more)

### Community 150 - "SymbolIndex"
Cohesion: 0.21
...
Cohesion: 0.19
Nodes (11): test_compact_task_matrix_adaptive_rendering(), test_auto_mark_task_completed_triggers_verification(), _clean_task_text(), get_compact_task_matrix(), _load_goal_spec(), Load goal_spec.json; returns None if missing or invalid., Generate an ultra-compact visual Task Matrix for LLM context injection.     Adap, Normalize task text by stripping list bullets, numbers, markdown formatting, and (+3 more)
...
### Community 155 - "LLMStateExtractor"
Cohesion: 0.15
...
Cohesion: 0.13
Nodes (16): DirectoryTree, Command palette + slash-command autocomplete for the Torchlight TUI.  Phase 4: *, DirEntry, git_status_for_tree(), GitFileTree, Path, Git-aware file tree for the Torchlight TUI.  Phase 4: the explorer's ``Directory, Check if a directory name should be skipped from exploration. (+8 more)
...
### Community 160 - ".format_l0_scratchpad"
Cohesion: 0.12
Nodes (8): Build critical context block from session state., Return headroom-aware budget allocations for the current turn., Pin a recently-read file slice so it survives compression without bloating conte, Remove a file from pinned memory if deleted or stale., Re-read an edited file from disk and update its pin in memory., Build the message list for the LLM.          Pinned files and dynamic L0 Scratch, Format current SessionState into a dynamic L0 working memory scratchpad., Manually compact context memory and return (before, after, freed).
...
### Community 167 - "validate_tool_call"
Cohesion: 0.11
...
### Community 172 - "HtmlGamePlayer"
Cohesion: 0.27
Nodes (8): get_process_memory_mb(), HtmlGamePlayer, Path, Autonomous HTML Game Harness & Dynamic Verifier.      Launches an ephemeral brow, Plays the HTML game for duration_ms while simulating inputs and checking frame d, Returns current process RSS memory load in Megabytes (MB)., Tier 1: Static HTML game parsing fallback when Playwright is unavailable., test_game_player_clean_canvas_static()

### Community 173 - "api/base.py"
Cohesion: 0.18
Nodes (8): Re-export LMStudioClient from shared core library core.api.lmstudio., detect_model_traits(), Abstract LLM client interface and shared inference parameters.  All LLM backends, Detect architecture traits (size, reasoning status) from model name.      Return, get_phase_inference_params(), LM Studio REST client.  Recovered from the original CLI implementation (commit f, Return the inference parameters preset for a named phase., test_detect_model_traits()
...
Cohesion: 0.16
Nodes (15): test_add_subtask_survives_sync_and_lands_in_plan(), test_sync_preserves_stable_ids_and_fields_across_reorder(), test_sync_workspace_tasks_populates_tasks_md(), test_update_task_graph_syncs_plan(), UPDATE_TASK_GRAPH — dynamically mutate sub-tasks in .torchlight/goal_spec.json., tool_update_task_graph_impl(), Generate a collision-free stable task id (never index-based)., Synchronize the canonical goal_spec.json with the plan/task markdown views. (+7 more)
...
Cohesion: 0.09
Nodes (35): Core Tools — built-in, always available, called via TOOL_NAME("arg") syntax.  Th, test_set_ctx_window(), Unit tests for context budget overflow detection and fixes in TieredMemory, RLME, test_tool_context_window_scaling(), test_list_dir_impl(), _ddg_search(), _detect_doc_source(), _extract_identifiers() (+27 more)

### Community 179 - "TestApp"
Cohesion: 0.22
Nodes (5): App, ComposeResult, on, Pressed, TestApp

### Community 180 - "risk_for_tool"
Cohesion: 0.33
Nodes (4): test_risk_for_tool(), test_target_from_args_line_ranges(), Risk tier for a tool call, mirroring the shared classification module., risk_for_tool()

### Community 181 - "play_and_verify_game"
Cohesion: 0.40
Nodes (5): play_and_verify_game(), Any, Plays an HTML game autonomously, analyzing frame buffers and runtime events., Executes closed-loop autonomous repair and verification on an HTML game., self_improve_game()

### Community 182 - "TieredMemory"
Cohesion: 0.06
Nodes (28): ContextSnapshot, is_valid_file_path(), Message, MessageRole, Calculate remaining token budget headroom before reaching max_tokens threshold., Predict likely next tools based on current state., Explicitly record a modified file, Net Delta line stats, and touched symbols in, Explicitly record a read file in session state if it is a valid file path. (+20 more)

### Community 187 - "Schema Reference"
Cohesion: 0.67
Nodes (3): `.context-memory.json` Schema, Schema Reference, Session File Schema

### Community 188 - ".solve_async"
Cohesion: 0.15
Nodes (10): ConversationSummarizer, Summarizer with LLM-powered and rule-based fallback paths.      When an llm_clie, Return True if the most recent test run actually ran and has failing or, estimate_metadata_overhead(), Estimate tokens consumed by system prompt, tool schemas, and the flashlight beam, build_step_message(), Build an explicit warning attached to an accepted final answer when the, SolveResult (+2 more)

### Community 191 - "TestApp"
Cohesion: 0.33
Nodes (3): App, ComposeResult, TestApp

### Community 199 - ".for_critic"
Cohesion: 0.40
...
- **Why does `TorchlightApp` connect `TorchlightApp` to `CommandPalette`, `test_resizer.py`, `CloudClient`, `AutonomousHarness`, `test_tui_plan_panel.py`, `GitFileTree`, `ToolCallCard`, `RLMEngineOptimized`, `PromptTextArea`, `PaneResizer`, `LlamaCppClient`, `MessageCard`, `test_tui_diff_view.py`, `test_tui_accessibility.py`, `Static`, `test_tui_tool_cards.py`, `tui_app.py`, `test_prompts_and_memory.py`, `ShortcutsHelpModal`, `Step`, `TaskManagerModal`, `test_tui_theme.py`, `on`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `TieredMemory` connect `TieredMemory` to `test_plan_execution_loop.py`, `TestRunResult`, `RLMEngine`, `AutonomousHarness`, `StreamingChatSession`, `cli/main.py`, `RLMEngineOptimized`, `.format_l0_scratchpad`, `TokenCounter`, `test_autonomous_harness.py`, `core/memory/manager.py`, `implementations.py`, `test_robust_task_tracking.py`, `tool_edit_file_impl`, `MemoryObject`, `.solve_async`, `SelectiveCompressor`, `test_prompts_and_memory.py`, `Step`, `rlm_engine_optimized.py`, `MemoryConfig`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `RLMEngineOptimized` connect `RLMEngineOptimized` to `datetime`, `TrajectoryLock`, `test_plan_execution_loop.py`, `REPLSandbox`, `test_resizer.py`, `ProjectMemory`, `AutonomousHarness`, `test_tui_plan_panel.py`, `DebateVerifier`, `.format_l0_scratchpad`, `TorchlightApp`, `PaneResizer`, `main_optimized.py`, `ExecutionFeedbackLoop`, `LlamaCppClient`, `MessageCard`, `test_tui_diff_view.py`, `ProjectMemory`, `TieredMemory`, `.solve_async`, `Static`, `test_inline_interception.py`, `test_tui_tool_cards.py`, `test_timeout_retry.py`, `tui_app.py`, `test_prompts_and_memory.py`, `ShortcutsHelpModal`, `ToolResult`, `Step`, `TaskManagerModal`, `rlm_engine_optimized.py`, `on`, `MemoryConfig`?**
