...
## Corpus Check
- 164 files · ~241,672 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2400 nodes · 4389 edges · 169 communities (141 shown, 28 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 237 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d55451a`
...
Cohesion: 0.10
Nodes (34): test_list_dir_impl(), _ddg_search(), _detect_doc_source(), _extract_identifiers(), _git_run(), Unified tool implementations for Torchlight.  All tool functions follow the sign, LIST_DIR — list directory contents., WEB_SEARCH — general web search. (+26 more)
...
### Community 7 - "context_manager/memory/manager.py"
Cohesion: 0.12
...
### Community 15 - "SelectiveCompressor"
Cohesion: 0.14
...
### Community 30 - "[v1.7.0] - 2026-07-29"
Cohesion: 0.40
Nodes (4): Added, Changelog, Fixed & Improved, [v1.7.0] - 2026-07-29

### Community 31 - "RLMEngineOptimized"
Cohesion: 0.06
Nodes (29): test_rlm_engine_debate_verifier_error_resilience(), test_rlm_engine_optimized_code_execution(), test_rlm_engine_optimized_debate_verifier_initialization(), test_rlm_engine_optimized_none_tool_name(), test_rlm_engine_solve_method(), CloudClient, Sanitize message roles. Convert system role to user role for models (e.g. Gemma, Async implementation of chat protocol method required by LLMClient and DebateVer (+21 more)
...
Cohesion: 0.10
Nodes (25): Tests for SEARCH_AST tool implementation and Kuzu connection handling., test_search_ast_impl_fallback(), test_search_ast_schema_validation(), test_get_tool_registry(), test_tool_registry_preview_dry_run(), test_get_openai_tools_schema(), test_validate_tool_call_alias(), test_validate_tool_call_missing_required() (+17 more)
...
### Community 37 - "autonomous_harness.py"
Cohesion: 0.18
...
Cohesion: 0.11
Nodes (17): Tiered Memory Manager for Torchlight.  L0-L3 memory hierarchy with progressive c, _detect_apple_silicon_ram(), _detect_chip(), fetch_provider_models(), is_port_in_use(), list_available_models(), normalize_model_name(), Normalize model alias names (e.g. 'gemma-2-2b', 'qwen', 'gemma 4 E2B'). (+9 more)
...
Cohesion: 0.09
Nodes (32): _build_excerpt(), LLM-powered SessionState extractor.  Replaces the regex-based _merge_summary_int, Build a compact conversation view for the extraction prompt., MemoryConfig, Create a MemoryConfig automatically tuned for the given context window size and, ContentChunk, ContentType, ContextSnapshot (+24 more)
...
### Community 50 - ".solve_async"
Cohesion: 0.22
Nodes (6): Ensure target project has local git repository and persistent memory initialized, ExecutionFeedbackLoop, Path, Switch the active workspace, keeping the sandbox's AST-graph         lookups (ge, SolveResult, Step
...
Cohesion: 0.11
Nodes (25): Unit tests for Torchlight Zero-Context Code Quality Harness., test_check_syntax_js_bracket_balance(), test_check_syntax_json(), test_check_syntax_python(), test_detect_stubs(), test_format_code_on_save_fallback(), test_normalize_whitespace(), test_tool_edit_file_integration() (+17 more)
...
Cohesion: 0.08
Nodes (21): ContextSnapshot, MemoryConfig, Return list of (path, content) for pinned files., Remove all pinned files., Compress older messages, preserving the first N messages., Async wrapper for compress_recent., Calculate remaining token budget headroom before reaching max_tokens threshold., Predict likely next tools based on current state. (+13 more)
...
Cohesion: 0.17
Nodes (6): _extract_errors(), _extract_failing_tests(), _extract_file_paths(), Message, MessageRole, MemoryNeedle
...
### Community 155 - "core/compression/summarizer.py"
Cohesion: 0.24
...
### Community 163 - ".format_l0_scratchpad"
Cohesion: 0.33
...
### Community 164 - "context_manager/execution/feedback_loop.py"
Cohesion: 0.39
...
- **Why does `TieredMemory` connect `TieredMemory` to `cli/main.py`, `.format_l0_scratchpad`, `autonomous_harness.py`, `RLMEngine`, `rlm_engine_optimized.py`, `test_prompts_and_memory.py`, `ExecutionFeedbackLoop`, `SelectiveCompressor`, `.solve_async`, `.refresh_pin`, `AutonomousHarness`, `core/memory/__init__.py`, `test_context_budget_overflow.py`, `.__init__`, `StreamingChatSession`, `RLMEngineOptimized`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `TieredMemory` connect `TieredMemory` to `context_manager/memory/manager.py`, `_EvictingDeque`, `LLMStateExtractor`, `RLMEngine`, `context_manager/memory/persistence.py`, `SelectiveCompressor`, `.refresh_pin`, `build_embedder`, `ProjectMemory`, `.append`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `StreamingChatSession` connect `StreamingChatSession` to `cli/main.py`, `TieredMemory`, `._build_messages`, `.__init__`, `test_phase_detection.py`?**
