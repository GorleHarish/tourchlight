...
## Corpus Check
- 175 files · ~125,518 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2539 nodes · 4930 edges · 163 communities (140 shown, 23 thin omitted)
...
## Communities (163 total, 23 thin omitted)
...
### Community 46 - "Step"
Cohesion: 0.17
Nodes (13): ConversationSummarizer, Summarizer with LLM-powered and rule-based fallback paths.      When an llm_clie, MemoryConfig, Create a MemoryConfig automatically tuned for the given context window size and, Message, MessageRole, test_rlm_engine_solve_method(), REPLSandbox (+5 more)
...
Cohesion: 0.11
Nodes (27): test_list_available_models_includes_gemma4e4b(), test_normalize_gemma_4_4e4b_variants(), test_normalize_gemma_4_e2b_variants(), test_normalize_mlx_gemma_4_4e4b(), _detect_apple_silicon_ram(), _detect_chip(), fetch_provider_models(), list_available_models() (+19 more)
...
- **Why does `AutonomousHarness` connect `AutonomousHarness` to `ApprovalModal`, `SymbolIndex`, `TieredMemory`, `on`, `.__init__`, `TieredMemory`, `core/memory/manager.py`, `TorchlightApp`, `core/execution/feedback_loop.py`, `ExecutionFeedbackLoop`, `Static`, `ProjectMemory`, `cli/main.py`, `tui_app.py`, `StreamingChatSession`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `TieredMemory` connect `TieredMemory` to `TokenCounter`, `.__init__`, `_EvictingDeque`, `context_manager/memory/persistence.py`, `Step`, `RLMEngineOptimized`, `context_manager/memory/manager.py`, `cli/main.py`, `build_embedder`, `ProjectMemory`, `AutonomousHarness`, `.refresh_pin`, `StreamingChatSession`, `LLMStateExtractor`?**
